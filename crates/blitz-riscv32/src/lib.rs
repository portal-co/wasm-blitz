//! RISC-V 32-bit code generation backend for wasm-blitz.
//!
//! This crate provides functionality to compile WebAssembly bytecode into native
//! RISC-V 32-bit machine code. The backend targets the RV32 instruction set and
...
pub use portal_solutions_asm_riscv32::*;
